...
def inference(mris, keep_prob):
  ...
  group5_6_7_t1 = _3conv_pool(group3_4_t1,
                        'conv5_t1', 'conv6_t1', 'conv7_t1', 'pool7_t1',
                        [3, 3, 3, 8, 16], [1, 1, 1, 1, 1],
                        [3, 3, 3, 16, 16], [1, 1, 1, 1, 1],
                        [1, 2, 2, 2, 1], [1, 2, 2, 2, 1])
  group5_6_7_t1c = _3conv_pool(group3_4_t1c,
                        'conv5_t1c', 'conv6_t1c', 'conv7_t1c', 'pool7_t1c',
                        [3, 3, 3, 8, 16], [1, 1, 1, 1, 1],
                        [3, 3, 3, 16, 16], [1, 1, 1, 1, 1],
                        [1, 2, 2, 2, 1], [1, 2, 2, 2, 1])
  group5_6_7_t2 = _3conv_pool(group3_4_t2,
                        'conv5_t2', 'conv6_t2', 'conv7_t2', 'pool7_t2',
                        [3, 3, 3, 8, 16], [1, 1, 1, 1, 1],
                        [3, 3, 3, 16, 16], [1, 1, 1, 1, 1],
                        [1, 2, 2, 2, 1], [1, 2, 2, 2, 1])
  group5_6_7_fl = _3conv_pool(group3_4_fl,
                        'conv5_fl', 'conv6_fl', 'conv7_fl', 'pool7_fl',
                        [3, 3, 3, 8, 16], [1, 1, 1, 1, 1],
                        [3, 3, 3, 16, 16], [1, 1, 1, 1, 1],
                        [1, 2, 2, 2, 1], [1, 2, 2, 2, 1])
  print group5_6_7_t1
  
  group8_9_10_t1 = _3conv_pool(group5_6_7_t1,
                        'conv8_t1', 'conv9_t1', 'conv10_t1', 'pool10_t1',
                        [3, 3, 3, 16, 32], [1, 1, 1, 1, 1],
                        [3, 3, 3, 32, 32], [1, 1, 1, 1, 1],
                        [1, 2, 2, 2, 1], [1, 2, 2, 2, 1])
  group8_9_10_t1c = _3conv_pool(group5_6_7_t1c,
                        'conv8_t1c', 'conv9_t1c', 'conv10_t1c', 'pool10_t1c',
                        [3, 3, 3, 16, 32], [1, 1, 1, 1, 1],
                        [3, 3, 3, 32, 32], [1, 1, 1, 1, 1],
                        [1, 2, 2, 2, 1], [1, 2, 2, 2, 1])
  group8_9_10_t2 = _3conv_pool(group5_6_7_t2,
                        'conv8_t2', 'conv9_t2', 'conv10_t2', 'pool10_t2',
                        [3, 3, 3, 16, 32], [1, 1, 1, 1, 1],
                        [3, 3, 3, 32, 32], [1, 1, 1, 1, 1],
                        [1, 2, 2, 2, 1], [1, 2, 2, 2, 1])
  group8_9_10_fl = _3conv_pool(group5_6_7_fl,
                        'conv8_fl', 'conv9_fl', 'conv10_fl', 'pool10_fl',
                        [3, 3, 3, 16, 32], [1, 1, 1, 1, 1],
                        [3, 3, 3, 32, 32], [1, 1, 1, 1, 1],
                        [1, 2, 2, 2, 1], [1, 2, 2, 2, 1])
  print group8_9_10_t1

  group11_12_13_t1 = _3conv_pool(group8_9_10_t1,
                        'conv11_t1', 'conv12_t1', 'conv13_t1', 'pool13_t1',
                        [3, 3, 3, 32, 64], [1, 1, 1, 1, 1],
                        [3, 3, 3, 64, 64], [1, 1, 1, 1, 1],
                        [1, 2, 2, 2, 1], [1, 2, 2, 2, 1])
  group11_12_13_t1c = _3conv_pool(group8_9_10_t1c,
                        'conv11_t1c', 'conv12_t1c', 'conv13_t1c', 'pool13_t1c',
                        [3, 3, 3, 32, 64], [1, 1, 1, 1, 1],
                        [3, 3, 3, 64, 64], [1, 1, 1, 1, 1],
                        [1, 2, 2, 2, 1], [1, 2, 2, 2, 1])
  group11_12_13_t2 = _3conv_pool(group8_9_10_t2,
                        'conv11_t2', 'conv12_t2', 'conv13_t2', 'pool13_t2',
                        [3, 3, 3, 32, 64], [1, 1, 1, 1, 1],
                        [3, 3, 3, 64, 64], [1, 1, 1, 1, 1],
                        [1, 2, 2, 2, 1], [1, 2, 2, 2, 1])
  group11_12_13_fl = _3conv_pool(group8_9_10_fl,
                        'conv11_fl', 'conv12_fl', 'conv13_fl', 'pool13_fl',
                        [3, 3, 3, 32, 64], [1, 1, 1, 1, 1],
                        [3, 3, 3, 64, 64], [1, 1, 1, 1, 1],
                        [1, 2, 2, 2, 1], [1, 2, 2, 2, 1])
  print group11_12_13_t1
  ...
  with tf.variable_scope('local14') as scope:
    ...
    local14 = tf.nn.relu(tf.matmul(reshape, weights) + biases, name=scope.name)
    local14 = tf.nn.dropout(local14, keep_prob)
    _activation_summary(local14)
  print local14
  ...
  with tf.variable_scope('local15') as scope:
    ...
    local15 = tf.nn.relu(tf.matmul(local14, weights) + biases, name=scope.name)
    local15 = tf.nn.dropout(local15, keep_prob)
    _activation_summary(local15)
  print local15
  ...
  with tf.variable_scope('local16') as scope:
    ...
    local16 = tf.add(tf.matmul(local15, weights), biases, name=scope.name)
    local16 = tf.nn.dropout(local16, keep_prob)
    _activation_summary(local16)
  print local16
